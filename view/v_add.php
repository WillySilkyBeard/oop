<div class="col-md-6">
	<form method="post">
		<label for="addInput">Название</label>
		<input class="form-control" id="addInput" type="text" name="title" value="<?=$data['title']?>"><br>
		<label for="addTa">Текст</label>
		<textarea class="form-control" id="addTa" name="content"><?$data['content']?></textarea><br>
